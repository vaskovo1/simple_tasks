...
try-except, которая выводит сумму всех введенных чисел, а затем — количество
...
Программа должна вывести сумму всех введенных чисел (тип int и float), а затем
на следующей строке — количество введенных нечисловых значений.

Если ни одно число введено не было, то сумма равна 0.
...
for item in [st for st in stdin]:
    try:
        total += float(item)
    except:
        lst.append(item)
